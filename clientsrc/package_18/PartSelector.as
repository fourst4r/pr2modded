package package_18
{
   ...
   public class PartSelector extends Sprite
   {
      ...
      public var arrows:ArrowButtons;
      
      public var cp:ColorPicker;
      
      public var cp2:ColorPicker;
      ...
      public var var_182:DisplayObject;
      ...
      public function method_737(param1:int, param2:int) : DisplayObject
      {
      ...
      public function method_809(param1:int, param2:int) : DisplayObject
      {
         var _loc3_:Sprite = new Sprite();
      ...
      public function onColorChange(param1:Event) : *
      {
      ...
      public function onArrowClick(param1:Event) : *
      {
