package menu
{
   ...
   public class CreditsPopup extends Popup
   {
      ...
      public const artPgs:int = 3;
      
      public var artPg:int = 1;
      
      public var musicPg:int = 1;
      
      public var m:CreditsPopupGraphic;
      ...
      public function clickArtNav(param1:TextEvent) : *
      {
      ...
      public function clickMusicNav(param1:TextEvent) : *
      {
