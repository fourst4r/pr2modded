package
{
   ...
   public dynamic class ItemBlockOptionsGraphic extends MovieClip
   {
      ...
      public function ItemBlockOptionsGraphic()
      {
         super();
         this.__setProp_check1_ItemBlockOptions_Layer9_0();
         this.__setProp_check6_ItemBlockOptions_Layer8_0();
         this.__setProp_check3_ItemBlockOptions_Layer7_0();
         this.__setProp_check4_ItemBlockOptions_Layer6_0();
         this.__setProp_check7_ItemBlockOptions_Layer5_0();
         this.__setProp_check5_ItemBlockOptions_Layer4_0();
         this.__setProp_check8_ItemBlockOptions_Layer3_0();
         this.__setProp_check2_ItemBlockOptions_Layer2_0();
         this.__setProp_check9_ItemBlockOptions_Layer1_0();
      }
      
      internal function __setProp_check1_ItemBlockOptions_Layer9_0() : *
      {
         try
         {
         ...
         this.check1.label = "Laser Gun";
         this.check1.labelPlacement = "right";
      ...
      internal function __setProp_check6_ItemBlockOptions_Layer8_0() : *
      {
         try
         {
         ...
         this.check6.label = "Jet Pack";
         this.check6.labelPlacement = "right";
      ...
      internal function __setProp_check3_ItemBlockOptions_Layer7_0() : *
      {
         try
         {
         ...
         this.check3.label = "Lightning";
         this.check3.labelPlacement = "right";
      ...
      internal function __setProp_check4_ItemBlockOptions_Layer6_0() : *
      {
         try
         {
         ...
         this.check4.label = "Teleport";
         this.check4.labelPlacement = "right";
      ...
      internal function __setProp_check7_ItemBlockOptions_Layer5_0() : *
      {
         try
         {
         ...
         this.check7.label = "Speed Burst";
         this.check7.labelPlacement = "right";
      ...
      internal function __setProp_check5_ItemBlockOptions_Layer4_0() : *
      {
         try
         {
         ...
         this.check5.label = "Super Jump";
         this.check5.labelPlacement = "right";
      ...
      internal function __setProp_check8_ItemBlockOptions_Layer3_0() : *
      {
         try
         {
         ...
         this.check8.label = "Sword";
         this.check8.labelPlacement = "right";
      ...
      internal function __setProp_check2_ItemBlockOptions_Layer2_0() : *
      {
         try
         {
         ...
         this.check2.label = "Mine";
         this.check2.labelPlacement = "right";
      ...
      internal function __setProp_check9_ItemBlockOptions_Layer1_0() : *
      {
         try
         {
         ...
         this.check9.label = "Ice Wave";
         this.check9.labelPlacement = "right";
