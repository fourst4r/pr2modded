package
{
   ...
   public dynamic class UploadingPopupGraphic extends MovieClip
   {
      ...
      public function UploadingPopupGraphic()
      {
         super();
         this.__setProp_close_bt_Uploading_Layer2_0();
      }
      
      internal function __setProp_close_bt_Uploading_Layer2_0() : *
      {
         try
         {
