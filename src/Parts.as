package
{
   public class Parts
   {
      ...
      protected static var init:Boolean = false;
      
      protected static const GREATEST_ID:int = 50;
      
      protected static const TYPES:Array = ["HAT","HEAD","BODY","FEET"];
      
      protected static const VARS_HAT:Array = ["NONE","EXP","KONG","PROP","COWBOY","CROWN","SANTA","PARTY","TOP","JUMP_START","MOON","THIEF","JIGG","ARTIFACT","JELLYFISH","CHEESE"];
      ...
      protected static const VARS_BODY:Array = ["CLASSIC","STRAP","DRESS","PEC","GUT","COLLAR","MISS_PR2","BELT","SNAKE","BIRD","INVISIBLE","BEE","STICK","CAT","CAR","ELEPHANT","ANT","ASTRONAUT","ALIEN","GALAXY","BUBBLE","DINO","ARMOR","FAIRY","GINGERBREAD","KING","QUEEN","SIR","FRED","VERY_INVISIBLE","TACO","SLENDER","","SANTA","FROST_DJINN","REINDEER","CROCODILE","VALENTINE","BUNNY","GECKO","BAT","SEA","BREW","","XMAS","SNOWMAN","","TURKEY","DOG","GLADIATOR"];
      ...
      protected static const VARS_FEET:Array = ["CLASSIC","HEEL","LOAFER","CLEAT","MAGNET","TINY","SANDAL","BARE","NICE","BIRD","INVISIBLE","STICK","CAT","TIRE","ELEPHANT","ANT","ASTRONAUT","ALIEN","GALAXY","DINO","ARMOR","FAIRY","GINGERBREAD","KING","QUEEN","SIR","VERY_INVISIBLE","BUBBLE","TACO","SLENDER","","","","SANTA","FROST_DJINN","REINDEER","CROCODILE","VALENTINE","BUNNY","GECKO","BAT","SEA","BREW","","XMAS","SNOWMAN","","TURKEY","DOG","GLADIATOR"];
      ...
      protected static function verifyPart(param1:String, param2:int) : *
      {
      ...
      protected static function makePart(param1:String, param2:int) : Object
      {
