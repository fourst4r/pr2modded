package
{
   ...
   public dynamic class ForgotPassPopupGraphic extends MovieClip
   {
      ...
      {
         super();
         this.__setProp_ok_bt_Symbol984_Layer6_0();
         this.__setProp_nameBox_Symbol984_Layer5_0();
         this.__setProp_cancel_bt_Symbol984_Layer4_0();
      }
      
      internal function __setProp_ok_bt_Symbol984_Layer6_0() : *
      {
         try
         {
      ...
      internal function __setProp_nameBox_Symbol984_Layer5_0() : *
      {
         try
         {
      ...
      internal function __setProp_cancel_bt_Symbol984_Layer4_0() : *
      {
         try
         {
