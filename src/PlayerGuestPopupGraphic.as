package
{
   ...
   public dynamic class PlayerGuestPopupGraphic extends MovieClip
   {
      ...
      public function PlayerGuestPopupGraphic()
      {
         super();
         this.__setProp_close_bt_PlayerGuestPopup_Layer2_0();
      }
      
      internal function __setProp_close_bt_PlayerGuestPopup_Layer2_0() : *
      {
         try
         {
