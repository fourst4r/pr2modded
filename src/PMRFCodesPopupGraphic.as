package
{
   ...
   public dynamic class PMRFCodesPopupGraphic extends MovieClip
   {
       
      
      public var close_bt:Button;
      
      public var linksBox:TextField;
      
      public function PMRFCodesPopupGraphic()
      {
         super();
         this.__setProp_close_bt_PMRFCodesPopup_head_btns_0();
      }
      
      internal function __setProp_close_bt_PMRFCodesPopup_head_btns_0() : *
      {
         try
         {
